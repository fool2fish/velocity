...
Engine.prototype.Render = function(context, template) {
  ...
  if (templ.isFile) {
    ...
    if (templ.fullPath) {
      ...
      // TODO: need confirm
      return this.initFailInfo('Template not exists or not subpath of roots.', template.pos)
    }
  } else {
...
Engine.prototype.Statements = function(node) {
  ...
  for (var i = 0; i < node.body.length; i++) {
    ...
    } else if (cr.stats === STATS.BREAK || cr.stats === STATS.STOP) {
...
Engine.prototype.mergeFailInfo = function(target, src) {
...
Engine.prototype.BREAK_STOP_ERR = 'Illegal #break or #stop.'

...
Engine.prototype.render = function(context) {
  ...
  if (result.stats === STATS.SUCCESS || result.stats === STATS.STOP) {
    ...
    var e = new Error(result.message || 'Illegal #break.')
        e.stack = stack
        e.line = originTempl.lines[originPos.first_line - 1]
        e.position = originPos
    throw e
  }
}
...
Engine.printError = function(err) {
  console.log()
  console.log(markError(err.line, err.position))
  console.log()
  console.log('Error: ' + err.message)
  console.log('  at: ' + err.stack.join('\n  at: '))
  console.log()
}

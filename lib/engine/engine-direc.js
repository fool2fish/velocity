...
module.exports = {
  ...
  Evaluate: function(node) {
    ...
    if (result.stats === STATS.FAIL) {
      return this.initFailInfo('Evaluate error.', node.pos)
  ...
  Macro: function(node, isGlobal) {
    ...
    var macro = isGlobal ? this.macro : this.template.__macro
  ...
  MacroCall: function(node) {
    ...
    var definitionTempl = name in this.template.__macro ? this.template : this.cfg.macro

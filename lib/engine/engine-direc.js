...
module.exports = {
  ...
  Include: function(node) {
    ...
    for (var i = 0; i < args.length; i++) {
      ...
      if (isEmptyStr(relPath)) {
        var fail =  this.initFailInfo('Param of #include could not be empty string.', arg.pos)
      ...
      if (fullPath) {
        ...
        var fail = this.initFailInfo('Param of #include is not a existed file.', arg.pos)
        this.mergeRessult(result, fail)
        break
      }
    }

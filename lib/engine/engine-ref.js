...
module.exports = {
  ...
  Method: function(node) {
    ...
    if (typeof calleer.value !== 'function') {
      ...
      if (typeof o === 'string' && p === 'length' && l === 0) {
        return {
          stats: STATS.SUCCESS,
          value: calleer.value
        }
      ...
      if (Array.isArray(o) && p === 'isEmpty' && l === 0) {
        return {
          stats: STATS.SUCCESS,
          value: !o.length
        }
      ...
      if (common.isObject(o) && p === 'entrySet' && l === 0) {
        return {
          stats: STATS.SUCCESS,
      ...
      if (common.isObject(o) && p === 'keySet' && l === 0) {
        return {
          stats: STATS.SUCCESS,
          value: Object.keys(o)
        }
      ...
      var isArrOrObj = (typeOfO === 'object' && typeOfO !== 'function')
      var arg0 = argsv[0]
      var arg1 = argsv[1]
      ...
      if (common.isObject(o) && p.indexOf('is') === 0 && p.length > 2 && l === 0) {
        return {
          stats: STATS.SUCCESS,
          value: !!o[extractProp(p)]
        }

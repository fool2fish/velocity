...
break;
case 89: this.$ = {type: 'Macro', name: $$[$0-3], arguments: [], body: $$[$0-1]}; 
break;
case 90: this.$ = {type: 'Macro', name: $$[$0-4], arguments: $$[$0-2]}; 
break;
case 91: this.$ = {type: 'Macro', name: $$[$0-2], arguments: []}; 
break;
case 92: this.$ = {type: 'MacroCall', name: $$[$0-3].replace(/^#{?|}$/g, ''), arguments: $$[$0-1]}; 
break;
case 93: this.$ = {type: 'MacroCall', name: $$[$0-2].replace(/^#{?|}$/g, ''), arguments: []}; 
break;
case 94: this.$ = {type: 'MacroCall', name: $$[$0-5].replace(/^#@{?|}$/g, ''), arguments: $$[$0-3], isBlock: true, body: $$[$0-1]}; 
break;
case 95: this.$ = {type: 'MacroCall', name: $$[$0-4].replace(/^#@{?|}$/g, ''), arguments: [], isBlock: true, body: $$[$0-1]}; 
break;
case 96: this.$ = {type: 'MacroCall', name: $$[$0-4].replace(/^#@{?|}$/g, ''), arguments: $$[$0-2], isBlock: true}; 
break;
case 97: this.$ = {type: 'MacroCall', name: $$[$0-3].replace(/^#@{?|}$/g, ''), arguments: [], isBlock: true}; 
break;

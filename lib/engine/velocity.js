...
break;
case 83: this.$ = {type: 'Include', pos: this._$, arguments: $$[$0-1]}; 
break;
case 84: this.$ = {type: 'Parse', pos: this._$, argument: $$[$0-1]}; 
break;
case 85: this.$ = {type: 'Evaluate', pos: this._$, argument: $$[$0-1]}; 
break;
case 86: this.$ = {type: 'Define', pos: this._$, name: $$[$0-3], body: $$[$0-1]}; 
break;
case 87: this.$ = {type: 'Define', pos: this._$, name: $$[$0-2]}; 
break;
case 88: this.$ = {type: 'Macro', pos: this._$, name: $$[$0-5], arguments: $$[$0-3], body: $$[$0-1]}; 
break;
case 89: this.$ = {type: 'Macro', pos: this._$, name: $$[$0-3], arguments: [], body: $$[$0-1]}; 
break;
case 90: this.$ = {type: 'Macro', pos: this._$, name: $$[$0-4], arguments: $$[$0-2]}; 
break;
case 91: this.$ = {type: 'Macro', pos: this._$, name: $$[$0-2], arguments: []}; 
break;
case 92: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-3].replace(/^#{?|}$/g, ''), arguments: $$[$0-1]}; 
break;
case 93: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-2].replace(/^#{?|}$/g, ''), arguments: []}; 
break;
case 94: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-5].replace(/^#@{?|}$/g, ''), arguments: $$[$0-3], isBlock: true, body: $$[$0-1]}; 
break;
case 95: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-4].replace(/^#@{?|}$/g, ''), arguments: [], isBlock: true, body: $$[$0-1]}; 
break;
case 96: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-4].replace(/^#@{?|}$/g, ''), arguments: $$[$0-2], isBlock: true}; 
break;
case 97: this.$ = {type: 'MacroCall', pos: this._$, name: $$[$0-3].replace(/^#@{?|}$/g, ''), arguments: [], isBlock: true}; 
break;
case 98: this.$ = {type: 'Stop', pos: this._$}; 
break;
case 99: this.$ = {type: 'Break', pos: this._$}; 
break;
case 100: this.$ = undefined; 
break;
case 101: this.$ = $$[$0]; 
break;
case 102: this.$ = {type: 'If', pos: this._$, test: $$[$0-2], consequent: $$[$0]}; 
break;
case 103: this.$ = {type: 'If', pos: this._$, test: $$[$0-1]}; 
break;
case 104: this.$ = {type: 'If', pos: this._$, test: $$[$0-3], consequent: $$[$0-1], alternate: $$[$0]}; 
break;
case 105: this.$ = {type: 'If', pos: this._$, test: $$[$0-2], alternate: $$[$0]}; 
break;
case 106: this.$ = {type: 'If', pos: this._$, test: $$[$0-3], consequent: $$[$0-1], alternate: $$[$0]}; 
break;
case 107: this.$ = {type: 'If', pos: this._$, test: $$[$0-2], alternate: $$[$01]}; 
break;
case 108: this.$ = {type: 'If', pos: this._$, test: $$[$0-3], consequent: $$[$0-1]}; 
break;
case 109: this.$ = {type: 'If', pos: this._$, test: $$[$0-2]}; 
break;
case 110: this.$ = {type: 'If', pos: this._$, test: $$[$0-4], consequent: $$[$0-2], alternate: $$[$0-1]}; 
break;
case 111: this.$ = {type: 'If', pos: this._$, test: $$[$0-3],  alternate: $$[$0-1]}; 
break;
case 112: this.$ = {type: 'If', pos: this._$, test: $$[$0-4], consequent: $$[$0-2], alternate: $$[$0-1]}; 
break;
case 113: this.$ = {type: 'If', pos: this._$, test: $$[$0-3], alternate: $$[$0-1]}; 
break;
case 114: this.$ = [$$[$0]]; 
break;
...
rules: [/^(?:(\\\$|\\#|[^\$\#])+)/,/^(?:#\[\[[\s\S]*?\]\]#)/,/^(?:##.*)/,/^(?:#\*[\s\S]*?\*#)/,/^(?:\$(?=!?\{?([a-zA-Z_][a-zA-Z0-9-_]*)))/,/^(?:!)/,/^(?:\{)/,/^(?:([a-zA-Z_][a-zA-Z0-9-_]*))/,/^(?:([a-zA-Z_][a-zA-Z0-9-_]*))/,/^(?:\.([a-zA-Z_][a-zA-Z0-9-_]*))/,/^(?:\[)/,/^(?:\])/,/^(?:\()/,/^(?:\))/,/^(?:\{)/,/^(?:\})/,/^(?:$)/,/^(?:)/,/^(?:\s+)/,/^(?::)/,/^(?:,)/,/^(?:\.\.)/,/^(?:in\b)/,/^(?:true|false|null\b)/,/^(?:==|!=|>=|<=|>|<)/,/^(?:&&|\|\||!)/,/^(?:[\+\-\*\/\%])/,/^(?:=)/,/^(?:\d+\.\d+)/,/^(?:\d+)/,/^(?:"(\\"|[^\"])*")/,/^(?:'(\\'|[^\'])*')/,/^(?:#(\{set\}|set)((?=[ \t]*\()))/,/^(?:#(\{if\}|if)((?=[ \t]*\()))/,/^(?:#(\{elseif\}|elseif)((?=[ \t]*\()))/,/^(?:#(\{else\}|else(?!([a-zA-Z]))))/,/^(?:#(\{end\}|end(?!([a-zA-Z]))))/,/^(?:#(\{foreach\}|foreach)((?=[ \t]*\()))/,/^(?:#(\{include\}|include)((?=[ \t]*\()))/,/^(?:#(\{parse\}|parse)((?=[ \t]*\()))/,/^(?:#(\{stop\}|stop(?!([a-zA-Z]))))/,/^(?:#(\{break\}|break(?!([a-zA-Z]))))/,/^(?:#(\{evaluate\}|evaluate)((?=[ \t]*\()))/,/^(?:#(\{define\}|define)((?=[ \t]*\()))/,/^(?:#(\{macro\}|macro)((?=[ \t]*\()))/,/^(?:#(\{([a-zA-Z])+\}|([a-zA-Z])+)((?=[ \t]*\()))/,/^(?:#@(\{([a-zA-Z])+\}|([a-zA-Z])+)((?=[ \t]*\()))/,/^(?:[ \t]*\()/,/^(?:[ \t]*\(\s*)/,/^(?:([a-zA-Z_][a-zA-Z0-9-_]*))/,/^(?:\s*,\s*)/,/^(?:\s*\))/,/^(?:\s+)/,/^(?:[\$\#])/,/^(?:$)/],
